...
6. **Short trading deferred** — Alpaca rejects fractional short sells. Long-only until capital supports whole-share sizing.
...
- **Live trade log current to Apr 9** — Alpaca MCP verified through Apr 9. pm2/DB audit pending for Apr 6–9 entries. Run SSH audit before Apr 20 calibration to confirm DB records match. GLD/SLV/GDX open overnight Apr 9 — log those exits when they close.
