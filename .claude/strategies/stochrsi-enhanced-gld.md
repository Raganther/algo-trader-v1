...
>
> **May 7 2026 caveat (now superseded by May 9 above for magnitude).** Sharpe figures below were close-anchored backtests with apparent ~0.7 Sharpe live-vs-backtest gap (1-bar polling delay artifact, see `.claude/calibration/live-vs-backtest-iau-diagnostic.md`). May 8 PM ADX-bug finding showed most of that gap was the bug, not pure delay; May 9 re-run quantified the bug-fixed values directly.
